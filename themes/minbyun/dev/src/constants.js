...
export const FOCUSIN_USER_PROFILE = 'focusin user profile';
export const COMPLETE_USER_PROFILE = 'complete user profile';
export const SUBMIT_USER_PROFILE = 'submit user profile';
export const INITIALIZE_USER_REGIST = 'initialize user regist';
export const INITIALIZE_USER_REGIST_FIELD = 'initialize user regist form';
export const CHANGE_USER_REGIST = 'change user regist profile';
